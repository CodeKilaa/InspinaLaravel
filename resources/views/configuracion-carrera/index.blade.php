...
<head>
    ...
    <title>Configuración-Carrera</title>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-6"><h3 class="m-t-none m-b">Ingrese los Datos</h3>
                                                            ...
                                                            <form role="form">
                                                                <div class="form-group"><label>Carrera</label> <input type="text" placeholder="Ingrese un nombre" class="form-control"></div>                                                              
                                                                <div>
                ...
                <div class="ibox-content col-lg-12">
                    ...
                    <table class="table table-bordered">
                                                    ...
                                                    <form role="form">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-10"><select class="form-control m-b" name="account">
                                                                ...
                                                                <option>Ingenieria de Software con IA</option>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12"><h3 class="m-t-none m-b">Ver</h3>
                                                ...
                                                <form role="form">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-10"><p class="form-control m-b" name="account">
                                                            <option>Diseño Grafico Digital</option>
                                                        <p/>                
                                                        </div>
                                                    </div>
                                                    <label class="col-form-label">Estado</label>
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-outline-success btn-primary dim" type="button"><span>Activo</span></i></button></td>
                            <td><button class="btn btn-info" type="button" href="#modal4-form" data-toggle="modal"><i class="fa fa-paste"></i></button></td>
                            <div id="modal4-form" class="modal fade" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                        ...
                        <td><button class="btn btn-success" type="button" href="#modaleye4-form" data-toggle="modal"><i class="fa fa-eye"></i></button></td>
                        <div id="modaleye4-form" class="modal fade" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="row">
                        ...
                        <tr>
                            ...
                            <td>Soporte</td>
                            <td><button class="btn btn-outline-success btn-primary dim" type="button"><span>Activo</span></i></button></td>
                            <td><button class="btn btn-info" type="button" href="#modal5-form" data-toggle="modal"><i class="fa fa-paste"></i></button></td>
                            <div id="modal5-form" class="modal fade" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                        ...
                        <td><button class="btn btn-success" type="button" href="#modaleye5-form" data-toggle="modal"><i class="fa fa-eye"></i></button></td>
                        <div id="modaleye5-form" class="modal fade" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="row">
