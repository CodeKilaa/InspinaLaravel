            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="horarioArea">Areas</a></li>
    ...
    <div class="col-lg-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Horario General Precencial - Area</strong>
            </li>
        </ol>
    </div>
</div>
                  ...
                  <table>
                    ...
                    <thead>
                      <tr class="m1">
                        ...
                        <th id="A1">Android</th>
                        <th id="A2">Programacion</th>
                        <th id="A3">Analisis</th>
                        <th id="A4">Estructura</th>
