                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-3 text-center">
                                            ...
                                            <button class="btn btn-success btn-sm m-t-n-xs" type="submit">Subir
                                                Imagen</button>

                                            </p>
                                        </div>
                                        <div class="col-sm-4 b-r">
                                            <h3 class="m-t-none m-b">Informacion Principal</h3>
                                            ...
                                            <form role="form">
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-8"><input type="text" placeholder=""
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <form role="form">
                                                <div class="form-group row"><label
                                                        class="col-lg-4 col-form-label">Fecha Nac:</label>
                                                    <div class="col-lg-8"><input type="text" placeholder=""
                                                            class="form-control"> <span
                                                            class="form-text m-b-none"></span>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="mb-4">
                                                    ...
                                                    <button class="btn btn-danger float-right mx-2" type="button"><i
                                                            class="fa fa-trash-o"></i></button>
                                                            <button class="btn btn-info float-right mx-2" type="button"
                                                            href="#modal-form2" data-toggle="modal"><i
                                                                class="fa fa-paste"></i></button>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="mb-4">
                                                    ...
                                                    <button class="btn btn-danger float-right mx-2" type="button"><i
                                                            class="fa fa-trash-o"></i></button>
                                                            <button class="btn btn-info float-right mx-2" type="button"
                                                        href="#modal-form3" data-toggle="modal"><i
                                                            class="fa fa-paste"></i></button>
                                                </div>
                ...
                <div id="right-sidebar">
                    <div class="sidebar-container">
                        ...
                        <ul class="nav nav-tabs navs-3">
                            ...
                            <li>
                                <a class="nav-link" data-toggle="tab" href="#tab-3"> <i class="fa fa-gear"></i>
                                </a>
                            </li>
                        </ul>
